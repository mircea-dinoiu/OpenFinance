Ext.define('Financial.controller.Data', {
    ...
    getExpensesData: function () {
        ...
        data.byUser.push(this.getGroupTotal(users));
        data.byML.push(this.getGroupTotal(mls));
    ...
    renderExpenses: function (expenses) {
        ...
        this.getReportGrid('expensesByML').getStore().loadData(byML);
        this.getReportGrid('expensesByUser').getStore().loadData(byUser);
    },
    ...
    renderIncomes: function (incomes) {
        ...
        this.getReportGrid('incomesByML').getStore().loadData(byML);
        this.getReportGrid('incomesByUser').getStore().loadData(byUser);
    },
    ...
    renderBalance: function (balance) {
        ...
        this.getReportGrid('balanceByML').getStore().loadData(byML);
